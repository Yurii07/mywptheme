...
function portfolio_register_all_scripts_and_styles() {
	// ======== CSS
...
add_action('wp_enqueue_scripts', 'portfolio_register_all_scripts_and_styles');

// ===================================================
// ==== Load All Scripts & Styles  ===================
// ===================================================

function portfolio_load_all_scripts_and_styles() {
...
add_action( 'wp_enqueue_scripts', 'portfolio_load_all_scripts_and_styles' );
